...
CREATE OR REPLACE VIEW __SNOWFLAKE_NGCA_DB__.MCE.SFMC_EMAIL_ENG_FINAL 
...
SELECT  THERAPEUTIC_AREA,
        ...
        FROM __SNOWFLAKE_NGCA_DB__.MCE.SFMC_EMAIL_ENG_BASE 
        WHERE OVERALL_DUPLICATE_FLAG = 0
              AND UPPER(UNSUBCRIBE_CLICKS_FLAG) = 'N' 
              AND UPPER(FIREWALL_CLICK_FLAG) = 'N'
        GROUP BY (
                  THERAPEUTIC_AREA, PRODUCT_NAME, BASE_TACTIC, ACTUAL_TACTIC_CODE,
                  TIME_DATE, IDENTIFIED_FLAG ,PARTY_CLASS, CUSTOMER_TYPE,
                  PARTY_SUBTYPE, TACTIC_CATEGORY, TACTIC_STREAM, TACTIC_SUB_STREAM, 
                  ACTIVITY_SOURCE, ACTIVITY_OFFER_DESCRIPTION, ACTIVITY_EM_NUMBER,
                  ACTIVITY_EM_NUMBER_WITH_AB_SPLIT,LEAD_SOURCE, WEB_LEAD_SOURCE, IS_ACTIVE,
                  GEO_REGION_CODE, MS_DIGITAL_SEGMENT, SMA_DIGITAL_SEGMENT, ALZ_DIGITAL_SEGMENT
                 )
...
SELECT  THERAPEUTIC_AREA,
        ...
        FROM __SNOWFLAKE_NGCA_DB__.MCE.SFMC_EMAIL_ENG_BASE 
		WHERE MONTHLY_DUPLICATE_FLAG = 0 
		      AND UPPER(UNSUBCRIBE_CLICKS_FLAG) = 'N' 
			  AND UPPER(FIREWALL_CLICK_FLAG) = 'N'
        GROUP BY (
		          THERAPEUTIC_AREA,PRODUCT_NAME,BASE_TACTIC,ACTUAL_TACTIC_CODE,
				  MONTH_DATE,IDENTIFIED_FLAG,PARTY_CLASS,CUSTOMER_TYPE,
				  PARTY_SUBTYPE,TACTIC_CATEGORY,TACTIC_STREAM,TACTIC_SUB_STREAM, 
				  ACTIVITY_SOURCE,ACTIVITY_OFFER_DESCRIPTION,ACTIVITY_EM_NUMBER,
                  ACTIVITY_EM_NUMBER_WITH_AB_SPLIT,LEAD_SOURCE,WEB_LEAD_SOURCE,IS_ACTIVE,
                  GEO_REGION_CODE,MS_DIGITAL_SEGMENT,SMA_DIGITAL_SEGMENT,ALZ_DIGITAL_SEGMENT
...
SELECT  THERAPEUTIC_AREA,
        ...
        BASE_TACTIC,
        ACTUAL_TACTIC_CODE,
        WEEK_BEGIN_DATE AS AGGREGATE_DATE,
        IDENTIFIED_FLAG,
        PARTY_CLASS,
        CUSTOMER_TYPE,
        PARTY_SUBTYPE,   
        ...
        FROM __SNOWFLAKE_NGCA_DB__.MCE.SFMC_EMAIL_ENG_BASE 
		WHERE WEEKLY_DUPLICATE_FLAG = 0 
		      AND UPPER(UNSUBCRIBE_CLICKS_FLAG) = 'N' 
			  AND UPPER(FIREWALL_CLICK_FLAG) = 'N'
        GROUP BY (
		          THERAPEUTIC_AREA,PRODUCT_NAME,BASE_TACTIC,ACTUAL_TACTIC_CODE,
				  WEEK_BEGIN_DATE,IDENTIFIED_FLAG,PARTY_CLASS,CUSTOMER_TYPE,
				  PARTY_SUBTYPE,TACTIC_CATEGORY,TACTIC_STREAM,TACTIC_SUB_STREAM,
				  ACTIVITY_SOURCE,ACTIVITY_OFFER_DESCRIPTION, ACTIVITY_EM_NUMBER,
                  ACTIVITY_EM_NUMBER_WITH_AB_SPLIT,LEAD_SOURCE,WEB_LEAD_SOURCE,IS_ACTIVE,
                  GEO_REGION_CODE,MS_DIGITAL_SEGMENT,SMA_DIGITAL_SEGMENT,ALZ_DIGITAL_SEGMENT
