...
SELECT 
	...
	act_dim.ADDRESS_LINE_1__V AS ADDRESS_1,
	act_dim.ADDRESS_LINE_2__V AS ADDRESS_2,
	act_dim.CITY,
	act_dim.STATE_CD AS STATE,
	act_dim.COUNTRY__V AS COUNTRY,
	act_dim.POSTAL_CODE AS ZIP_CODE,
	act_dim.WILLINGNESS_CAPABILITY_FLAG AS ACCOUNT_READINESS_FLAG,
	act_dim.PDRP_OPTOUT AS PDRP_OPT_OUT_FLAG,
